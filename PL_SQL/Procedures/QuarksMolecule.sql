CREATE OR REPLACE PROCEDURE QUARKS_MOLECULE(p_WEIGHT IN NUMBER, p_MOLECULE IN VARCHAR2) IS
...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('Hay una cantidad de: ' || v_MOLS || ' moles.');

    -- molecules = moles * avogadro / mol
    v_MOLECULES := MOLECULES(v_MOLS);
    DBMS_OUTPUT.PUT_LINE('Hay una cantidad de: ' || v_MOLECULES || ' moleculas.' || CHR(10));
    ...
    FOR i IN 1..LEAST(v_ELEMENTS_ARRAY.COUNT, v_SUBSCRIPTS_ARRAY.COUNT) LOOP
        ...
        SELECT ELEMENT_NAME INTO v_ELEMENT_NAME FROM ELEMENTS WHERE ELEMENT_SYMBOL = v_ELEMENTS_ARRAY(i);

        -- atoms = molecules * subscript / molecule 
        v_ATOMS := ATOMS(v_MOLECULES, v_SUBSCRIPTS_ARRAY(i));
        DBMS_OUTPUT.PUT_LINE('Hay una cantidad de: ' || v_ATOMS || ' átomos del elemento ' || v_ELEMENT_NAME || '.');

        -- #· PROTONS ·# --
        -- protons = atoms * elements[a]['Protons'] / atom 
        v_PROTONS := PROTONS(v_ELEMENTS_ARRAY(i), v_ATOMS);
        DBMS_OUTPUT.PUT_LINE('Hay una cantidad de: ' || v_PROTONS || ' PROTONES en los átomos del elemento ' || v_ELEMENT_NAME || '.');

        -- QUARK UP PROTONS --
        -- quarksup_protons = quarksup_arein_protons * protons / proton 
        v_QUARKSUP_PROTONS := QUARKSUP_PROTONS(v_PROTONS);
        DBMS_OUTPUT.PUT_LINE('Hay una cantidad de: ' || v_QUARKSUP_PROTONS || ' QUARKS UP en los PROTONES de los átomos del elemento ' || v_ELEMENT_NAME || '.');

        -- MeV_C2_QUARKSUP_PROTONS = quarksup_protons * 2.2 MeV / c^2
        v_MeV_C2_QUARKSUP_PROTONS := MeV_C2_QUARKSUP_PROTONS(v_QUARKSUP_PROTONS);
        DBMS_OUTPUT.PUT_LINE('Hay una cantidad de: ' || v_MeV_C2_QUARKSUP_PROTONS || ' MeV/c^2 QUARKS UP en los PROTONES de los átomos del elemento ' || v_ELEMENT_NAME || '.');
        ...
        DBMS_OUTPUT.PUT_LINE('Hay una cantidad de: ' || v_eV_C2_QUARKSUP_PROTONS || ' eV/c^2 QUARKS UP en los PROTONES de los átomos del elemento ' || v_ELEMENT_NAME || '.');
        ...
        DBMS_OUTPUT.PUT_LINE('Hay una cantidad de: ' || v_J_C2_QUARKSUP_PROTONS || ' J/c^2 QUARKS UP en los PROTONES de los átomos del elemento ' || v_ELEMENT_NAME || '.');
        ...
        DBMS_OUTPUT.PUT_LINE('Hay una cantidad de: ' || v_Kg_C2_QUARKSUP_PROTONS || ' Kg/c^2 QUARKS UP en los PROTONES de los átomos del elemento ' || v_ELEMENT_NAME || '.');

        -- Kg_quarksup_protons = Kg_C2_quarksup_protons / c^2
        v_Kg_QUARKSUP_PROTONS := Kg_QUARKSUP_PROTONS(v_Kg_C2_QUARKSUP_PROTONS);
        DBMS_OUTPUT.PUT_LINE('Hay una cantidad de: ' || v_Kg_QUARKSUP_PROTONS || ' Kg QUARKS UP en los PROTONES de los átomos del elemento ' || v_ELEMENT_NAME || '.');

        -- QUARKS DOWN PROTONS --
        -- quarksdown_protons = quarksdown_arein_protons * protons / proton
        v_QUARKSDOWN_PROTONS := QUARKSDOWN_PROTONS(v_PROTONS);
        DBMS_OUTPUT.PUT_LINE('Hay una cantidad de: ' || v_QUARKSDOWN_PROTONS || ' QUARKS DOWN en los PROTONES de los átomos del elemento ' || v_ELEMENT_NAME || '.');
        ...
        DBMS_OUTPUT.PUT_LINE('Hay una cantidad de: ' || v_MeV_C2_QUARKSDOWN_PROTONS || ' MeV/c^2 QUARKS DOWN en los PROTONES de los átomos del elemento ' || v_ELEMENT_NAME || '.');
        ...
        DBMS_OUTPUT.PUT_LINE('Hay una cantidad de: ' || v_eV_C2_QUARKSDOWN_PROTONS || ' eV/c^2 QUARKS DOWN en los PROTONES de los átomos del elemento ' || v_ELEMENT_NAME || '.');
        ...
        DBMS_OUTPUT.PUT_LINE('Hay una cantidad de: ' || v_J_C2_QUARKSDOWN_PROTONS || ' J/c^2 QUARKS DOWN en los PROTONES de los átomos del elemento ' || v_ELEMENT_NAME || '.');
        ...
        DBMS_OUTPUT.PUT_LINE('Hay una cantidad de: ' || v_Kg_C2_QUARKSDOWN_PROTONS || ' Kg/c^2 QUARKS DOWN en los PROTONES de los átomos del elemento ' || v_ELEMENT_NAME || '.');
        ...
        DBMS_OUTPUT.PUT_LINE('Hay una cantidad de: ' || v_Kg_QUARKSDOWN_PROTONS || ' Kg QUARKS DOWN en los PROTONES de los átomos del elemento ' || v_ELEMENT_NAME || '.');

        -- #· NEUTRONS ·# --
        -- neutrons = atoms * elements[a]['Neutrons'] / atom
        v_NEUTRONS := NEUTRONS(v_ELEMENTS_ARRAY(i), v_ATOMS);
        DBMS_OUTPUT.PUT_LINE('Hay una cantidad de: ' || v_NEUTRONS || ' NEUTRONES en los átomos del elemento ' || v_ELEMENT_NAME || '.');

        -- QUARKS UP NEUTRONS --
        -- quarksup_neutrons = quarksup_arein_neutrons * neutrons / neutron
        v_QUARKSUP_NEUTRONS := QUARKSUP_NEUTRONS(v_NEUTRONS);
        DBMS_OUTPUT.PUT_LINE('Hay una cantidad de: ' || v_QUARKSUP_NEUTRONS || ' QUARKS UP en los NEUTRONES de los átomos del elemento ' || v_ELEMENT_NAME || '.');
        ...
        DBMS_OUTPUT.PUT_LINE('Hay una cantidad de: ' || v_MeV_C2_QUARKSUP_NEUTRONS || ' MeV/c^2 QUARKS UP en los NEUTRONES de los átomos del elemento ' || v_ELEMENT_NAME || '.');
        ...
        DBMS_OUTPUT.PUT_LINE('Hay una cantidad de: ' || v_eV_C2_QUARKSUP_NEUTRONS || ' eV/c^2 QUARKS UP en los NEUTRONES de los átomos del elemento ' || v_ELEMENT_NAME || '.');
        ...
        DBMS_OUTPUT.PUT_LINE('Hay una cantidad de: ' || v_J_C2_QUARKSUP_NEUTRONS || ' J/c^2 QUARKS UP en los NEUTRONES de los átomos del elemento ' || v_ELEMENT_NAME || '.');
        ...
        DBMS_OUTPUT.PUT_LINE('Hay una cantidad de: ' || v_Kg_C2_QUARKSUP_NEUTRONS || ' Kg/c^2 QUARKS UP en los NEUTRONES de los átomos del elemento ' || v_ELEMENT_NAME || '.');

        -- Kg_quarksup_neutrons = Kg_C2_quarksup_neutrons / c^2
        v_Kg_QUARKSUP_NEUTRONS := Kg_QUARKSUP_NEUTRONS(v_Kg_C2_QUARKSUP_NEUTRONS);
        DBMS_OUTPUT.PUT_LINE('Hay una cantidad de: ' || v_Kg_QUARKSUP_NEUTRONS || ' Kg QUARKS UP en los NEUTRONES de los átomos del elemento ' || v_ELEMENT_NAME || '.');
        ...
        DBMS_OUTPUT.PUT_LINE('Hay una cantidad de: ' || v_QUARKSDOWN_NEUTRONS || ' QUARKS DOWN en los NEUTRONES de los átomos del elemento ' || v_ELEMENT_NAME || '.');
        ...
        DBMS_OUTPUT.PUT_LINE('Hay una cantidad de: ' || v_MeV_C2_QUARKSDOWN_NEUTRONS || ' MeV/c^2 QUARKS DOWN en los NEUTRONES de los átomos del elemento ' || v_ELEMENT_NAME || '.');
        ...
        DBMS_OUTPUT.PUT_LINE('Hay una cantidad de: ' || v_eV_C2_QUARKSDOWN_NEUTRONS || ' eV/c^2 QUARKS DOWN en los NEUTRONES de los átomos del elemento ' || v_ELEMENT_NAME || '.');
        ...
        DBMS_OUTPUT.PUT_LINE('Hay una cantidad de: ' || v_J_C2_QUARKSDOWN_NEUTRONS || ' J/c^2 QUARKS DOWN en los NEUTRONES de los átomos del elemento ' || v_ELEMENT_NAME || '.');
        ...
        DBMS_OUTPUT.PUT_LINE('Hay una cantidad de: ' || v_Kg_C2_QUARKSDOWN_NEUTRONS || ' Kg/c^2 QUARKS DOWN en los NEUTRONES de los átomos del elemento ' || v_ELEMENT_NAME || '.');
        ...
        DBMS_OUTPUT.PUT_LINE('Hay una cantidad de: ' || v_Kg_QUARKSDOWN_NEUTRONS || ' Kg QUARKS DOWN en los NEUTRONES de los átomos del elemento ' || v_ELEMENT_NAME || '.' || CHR(10));
