CREATE OR REPLACE PROCEDURE Subparticles_NitrogenatedBases(p_ARN VARCHAR2) IS
...
BEGIN
    ...
    FOR i IN 1..v_NB_ARRAY_P.COUNT LOOP
        v_NB_NAME_P := v_NB_NAME_P || GET_NITROGENATEDBASE_NAME(v_NB_ARRAY_P(i));
        -- Agregar un '+' después de cada elemento, excepto para el último.
        IF i < v_NB_ARRAY_P.COUNT THEN
    ...
    FOR i IN 1..v_NB_ARRAY_S.COUNT LOOP
        v_NB_NAME_S := v_NB_NAME_S || GET_NITROGENATEDBASE_NAME(v_NB_ARRAY_S(i));
        -- Agregar un '+' después de cada elemento, excepto para el último.
        IF i < v_NB_ARRAY_S.COUNT THEN
    ...
    FOR i IN 1..v_NB_ARRAY_P.COUNT LOOP
        v_NB_CHEMICALFORMULA_P := v_NB_CHEMICALFORMULA_P || GET_NITROGENATEDBASE_CHEMICALFORMULA(v_NB_ARRAY_P(i));
        -- Agregar un '+' después de cada elemento, excepto para el último.
        IF i < v_NB_ARRAY_P.COUNT THEN
    ...
    FOR i IN 1..v_NB_ARRAY_S.COUNT LOOP
        v_NB_CHEMICALFORMULA_S := v_NB_CHEMICALFORMULA_S || GET_NITROGENATEDBASE_CHEMICALFORMULA(v_NB_ARRAY_S(i));
        -- Agregar un '+' después de cada elemento, excepto para el último.
        IF i < v_NB_ARRAY_S.COUNT THEN
...
END Subparticles_NitrogenatedBases;