...
BEGIN
    ...
    SELECT DISTINCT QUARKS_UP_IN_PARTICLE INTO v_QUARKSUP_PROTONS FROM SUBPARTICLES_PARTICLES WHERE PARTICLE_ID = v_PARTICLE_ID AND QUARKS_UP_IN_PARTICLE IS NOT NULL;
