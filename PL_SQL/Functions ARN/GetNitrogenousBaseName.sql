CREATE OR REPLACE FUNCTION GET_NITROGENOUSBASE_NAME(v_NB_SYMBOL VARCHAR2) RETURN VARCHAR2 IS
    v_NB_NAME VARCHAR2(255); -- Declara una variable para almacenar el nombre de la base nitrogenada
BEGIN
    SELECT NITROGENOUSBASE_NAME INTO v_NB_NAME -- Realiza una consulta para obtener el nombre de la base nitrogenada
